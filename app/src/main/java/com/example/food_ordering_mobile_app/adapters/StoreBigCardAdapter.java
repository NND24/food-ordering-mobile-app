...
public class StoreBigCardAdapter extends RecyclerView.Adapter<StoreBigCardAdapter.ViewHolder> {
    ...
    public StoreBigCardAdapter(Context context, List<Store> stores) {
        this.context = context;
        this.stores = stores;
    }

    public StoreBigCardAdapter(Context context, List<Store> stores, OnStoreClickListener onStoreClickListener) {
        this.context = context;
        this.stores = stores;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context)
                .inflate(R.layout.item_store_big_card, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvStoreName, tvAvgRating, tvAmountRating, tvStoreFoodType, tvRatingOpen, tvRatingText, tvRatingClose, tvDot;
